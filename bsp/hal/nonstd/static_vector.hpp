        ...
        namespace fcv_detail
        {
            ...
            namespace storage
            {
                ...
                private:
                    ...
                    using aligned_storage_te = aligned_storage_t<sizeof(remove_const_t<T>), alignof(remove_const_t<T>)>;
                    using data_t = conditional_t<!Const<T>, aligned_storage_te, const aligned_storage_te>;
